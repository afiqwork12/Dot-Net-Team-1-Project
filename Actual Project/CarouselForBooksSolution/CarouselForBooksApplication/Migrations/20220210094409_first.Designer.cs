...
namespace CarouselForBooksApplication.Migrations
{
    ...
    [Migration("20220210094409_first")]
    partial class first
    {
            ...
            modelBuilder.Entity("CarouselForBooksApplication.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Cost = 22.2, DatePosted = new DateTime(2022, 2, 10, 17, 44, 9, 202, DateTimeKind.Local), Description = "Description 1", IsSold = false, Language = "English", Picture = "/images/book1.jpg", Title = "Title 1", UserId = 1 },
                        new { Id = 2, Cost = 22.2, DatePosted = new DateTime(2022, 2, 10, 17, 44, 9, 202, DateTimeKind.Local), Description = "Description 2", IsSold = false, Language = "English", Picture = "/images/book2.jfif", Title = "Title 2", UserId = 1 },
                        new { Id = 3, Cost = 22.2, DatePosted = new DateTime(2022, 2, 10, 17, 44, 9, 202, DateTimeKind.Local), Description = "Description 3", IsSold = false, Language = "English", Picture = "/images/book3.jpg", Title = "Title 3", UserId = 1 }
                    );
                });
            ...
            modelBuilder.Entity("CarouselForBooksApplication.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Dob = new DateTime(2022, 2, 10, 17, 44, 9, 200, DateTimeKind.Local), Email = "john123@gmail.com", Name = "John Wick", Password = "P@ssw0rd123", Username = "john123" }
                    );
                });
